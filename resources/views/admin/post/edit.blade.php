...
@section('content') 
        <div id="main-content" class="post" style="padding-top: 30px">
            <div class="page-title">
                ...
                <h3><strong>Sửa bài</strong></h3>
                <a href="{{ route('post.index') }}">
                    <i class="fa fa-angle-left"></i> <span>Trở lại</span>
                </a>
                <br>
            </div>
            <form id="post_form" action="{{ route('post.update',['id'=>$post->id]) }}" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-8 post-column-left">
                                        <div class="form-group">
                                            <input type="text" class="form-control f-18" name="title" id="title" placeholder="Tiêu đề bài viết..." value="{{$post->title}}">
                                        </div>
                                        <div class="form-group">
                                          <img src="public/uploads/post/{{$post->img}}" alt="">
                                        </div>
                                        <div class="form-group">
                                          ...
                                          <div class="col-md-3 ">
                                           ...
                                           <div class="col-md-3 ">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea rows="4" class="form-control" name="meta_description" >{{$post->meta_describe}}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <h5>Meta Keywords</h5>
                                                <textarea rows="6" class="form-control" name="meta_keyword">{{$post->meta_keyword}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
