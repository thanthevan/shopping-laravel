...
@section('head')
 <title>Unishop-Danh mục bài viết</title>
...
<div id="main-content">
            ...
            <div class="m-b-20 clearfix">
                <div class="page-title pull-left">
                    <h3 class="pull-left"><strong>Danh mục bài viết</strong></h3>
                </div>
        				...
        				<div class="modal-dialog">
        					<div class="modal-content">
        						...
        						<div class="modal-body">
        							  <form id="form1" class="form-horizontal"  method="post" action="{{route('categorypost.store')}}">
        							  	{{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" required name="parent_id">
                                                    ...
                                                    @php
                                                    	categoryadd($categorypost,0,null,0);
                                                    @endphp
                                                </select>
