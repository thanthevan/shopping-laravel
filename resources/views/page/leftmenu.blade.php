    <div class="offcanvas-container" id="shop-categories">
      <div class="offcanvas-header">
        <h3 class="offcanvas-title">Danh mục</h3>
      </div>
      <nav class="offcanvas-menu">
        <ul class="menu">
          <li class="has-children"><span><a href="#">Thời trang nam</a><span class="sub-menu-toggle"></span></span>
          ...
          <li class="has-children"><span><a href="#">Thời trang nữ</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
              <li><a href="#">Sandals</a></li>
    ...
    <div class="offcanvas-container" id="mobile-menu"><a class="account-link" href="account-orders.html"><i class="icon-head"></i><span>Hello</span>, John Doe</a>
      <nav class="offcanvas-menu">
        <ul class="menu">
          ...
          <li class="has-children"><span><a href="#">Sản phẩm</a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
          ...
          <li class="has-children"><span><a href="account-orders.html"><span>Tài khoản</span></a><span class="sub-menu-toggle"></span></span>
            <ul class="offcanvas-submenu">
